  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLabel"><b>Datos secretaria</b> <span class="pull-right"><button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
$(function(){
  $("#btnDeleteSend").click(function(){
    var id=$("#spanID").val();
    $.ajax({
      url:"/eliminar_secretaria",method:"post",
      data:{
        _token:"{{csrf_token()}}",
        id:id
      }
  ...
  $("#btnEditSend").click(function(){
    ...
    $.ajax({
      url:"/editar_secretaria",method:"post",
      data:{
        _token:"{{csrf_token()}}",
        id:id,
        nombre:nombre,
