  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLabel"><b>Datos notario</b> <span class="pull-right"><button type="button" class="close" data-dismiss="modal" aria-label="Close">
      ...
      <div class="modal-body">
        <div style="padding:5px" id="dataArea">
          ...
          <div class="form-group">
            ...
            <input maxLength="40" type="text" name="cedula" value="" class="form-control formInput">
          </div>
...
var setEvents=function(){
  ...
  $('.btnEdit').click(function(){
      ...
      $.ajax({
          ...
          $("input[name='cedula']").val(res.cedula)
...
$(function(){
  $("#btnDeleteSend").click(function(){
    var id=$("#spanID").val();
    $.ajax({
      url:"/eliminar_notario",method:"post",
      data:{
        _token:"{{csrf_token()}}",
        id:id
      }
  ...
  $("#btnEditSend").click(function(){
    ...
    $.ajax({
      url:"/editar_notario",method:"post",
      data:{
        _token:"{{csrf_token()}}",
        id:id,
        nombre:nombre,
